...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.addFilterAfter(jsonFilter, BasicAuthenticationFilter.class)
                ...
                .antMatchers("/v1/candidate/signup","/v1/candidate/google-verify","/v1/candidate/google-register","/v1/candidate/create-cv","/v1/candidate/update-favorite","/v1/candidate/favorite-posts").permitAll()
