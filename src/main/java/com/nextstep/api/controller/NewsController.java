...
import com.nextstep.api.mapper.NewsMapper;
import com.nextstep.api.model.Category;
import com.nextstep.api.model.News;
import com.nextstep.api.model.criteria.NewsCriteria;
import com.nextstep.api.repository.CategoryRepository;
import com.nextstep.api.repository.NewsRepository;
...
public class NewsController {
    ...
    public ApiMessageDto<ResponseListDto<List<NewsAutoCompleteDto>>> autoComplete(NewsCriteria newsCriteria) {
        ...
        newsCriteria.setStatus(NextStepConstant.STATUS_ACTIVE);
    ...
    public ApiMessageDto<String> create(@Valid @RequestBody CreateNewsForm createNewsForm, BindingResult bindingResult) {
        ...
        if (category == null || !Objects.equals(category.getKind(), NextStepConstant.CATEGORY_KIND_NEWS)) {
    ...
    public ApiMessageDto<String> update(@Valid @RequestBody UpdateNewsForm updateNewsForm, BindingResult bindingResult) {
        ...
        if(!Objects.equals(updateNewsForm.getCategoryId(), exsitingNews.getCategory().getId())){
            if(!Objects.equals(category.getKind(), NextStepConstant.CATEGORY_KIND_NEWS)){
                apiMessageDto.setResult(false);
