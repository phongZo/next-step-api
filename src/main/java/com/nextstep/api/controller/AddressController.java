...
import com.nextstep.api.dto.address.AddressAdminDto;
import com.nextstep.api.dto.address.AddressDto;
import com.nextstep.api.form.address.CreateAddressForm;
import com.nextstep.api.form.address.UpdateAddressForm;
import com.nextstep.api.mapper.AddressMapper;
import com.nextstep.api.model.Address;
import com.nextstep.api.model.Nation;
import com.nextstep.api.model.User;
import com.nextstep.api.model.criteria.AddressCriteria;
...
public class AddressController extends ABasicController {
    ...
    public ApiMessageDto<ResponseListDto<List<AddressDto>>> autoComplete(AddressCriteria addressCriteria){
        ...
        addressCriteria.setStatus(NextStepConstant.STATUS_ACTIVE);
